...
import mockDocuments from '../data/test-documents.json'
// import { pluginSecureProxy } from "@orama/plugin-secure-proxy"
import './App.css'

function App() {
  const [open, setOpen] = React.useState(false)
  const [oramaInstance, setOramaInstance] = React.useState<Orama<unknown> | null>(null)
	...
	useEffect(() => {
		const loadOrama = async () => {
          ...
          author: "string",
			...
			await insertMultiple(instance, mockDocuments)

			setOramaInstance(instance as Orama<unknown>)
		}
