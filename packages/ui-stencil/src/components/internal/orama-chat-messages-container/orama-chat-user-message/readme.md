...
| ------------- | ------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `interaction` | `interaction` |             | `{ query: string; response?: string; sources?: any; latest?: boolean; status: TAnswerStatus; interactionId?: string; relatedQueries?: string[]; }` | `undefined` |
